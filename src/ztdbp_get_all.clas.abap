CLASS ztdbp_get_all DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS ZTDBP_GET_ALL IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        out->write( | -----------Neil_20230814---------- | ).
        LOOP AT lt_osm INTO ls_osm.
          out->write( | Material_{ sy-tabix }:{ ls_osm-material_code },{ ls_osm-description },{ ls_osm-material_group } | ).
        ENDLOOP.
        out->write( | ---------------------------------- | ).
